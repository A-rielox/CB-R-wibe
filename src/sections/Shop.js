...
const Shop = () => {
   ...
   useLayoutEffect(() => {
      let element = ref.current; // toda la seccion
      let scrollingElement = horizontalRef.current; // CONTENEDOR DE LAS IMAGENES

      // HTMLElement.offsetWidth  devuelve el ancho del layout del elemento. ANCHO DEL CONTENEDOR DE LAS IMAGENES
      let pinWrapWidth = scrollingElement.offsetWidth;
      // console.log(pinWrapWidth); son =les
      // console.log(scrollingElement.scrollWidth); son =les

      let t1 = gsap.timeline();

      setTimeout(() => {
         // lo 1ro (element) es lo q animo
         t1.to(element, {
            scrollTrigger: {
               trigger: element,
               start: 'top top',
      ...
      <Section ref={ref} id="shop">
         ...
         <Left>
            <p>
               ...
               create our products using best quality material, including the
               use of some of the pure fabrics to make our products. All
